                ...
                <div class="row">
                    <div class="col-md-6" data-aos="zoom-in">
                        <div class="about-me-box shadow-box">
                            ...
                            <div class="img-box">
                                <img src="images/me_3.png" alt="About Me">
                            </div>
                            <div class="infos">
                                <h4>A GAME DEVLOPER</h4>
                                <h1>ANOOP KUMAR SHARMA.</h1>
                                <p>I am a Game Devloper based in India.</p>
                                    ...
                                    <div class="marquee">
                                        <div>
                                            <span>LATEST WORK AND <b>FEATURED</b> 
                                                <img src="fonts/star1.svg" alt="Star"> LATEST WORK AND <b>FEATURED</b> 
                                                <img src="fonts/star1.svg" alt="Star"> LATEST WORK AND <b>FEATURED</b> 
                                                <img src="fonts/star1.svg" alt="Star"> LATEST WORK AND <b>FEATURED</b> LATEST WORK AND 
                                                <img src="fonts/star1.svg" alt="Star"> LATEST WORK AND <b>FEATURED</b> LATEST WORK AND 
                                                <img src="fonts/star1.svg" alt="Star">
                                            </span>
                                        </div>
                                      </div>
                                </div>
                            ...
                            <div class="gx-row d-flex gap-24">
                                ...
                                <div data-aos="zoom-in">
                                    <div class="about-project-box info-box shadow-box h-full">
                                        <a class="overlay-link" href="./game.html"></a>
                                        <img src="images/bg1.png" alt="BG" class="bg-img">
                            ...
                            <div data-aos="zoom-in" class="flex-1">
                                <div class="about-services-box info-box shadow-box h-full">
                                    ...
                                    <div class="icon-boxes">
                                        ...
                                        <i class="iconoir-3d-bridge"></i>
                                        <i class="iconoir-nintendo-switch"></i>
                                        <i class="iconoir-square-cursor"></i>
                                    </div>
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="infos">
