                    ...
                    <div data-aos="zoom-in" class="contact-form">
                        <div class="shadow-box">
                            ...
                            <form>
                                ...
                                <div class="input-group">
                                    <button class="theme-btn submit-btn" name="submit" type="submit" onclick="sendemail(message)">Send Message</button>
                                </div>
                            </form>
                        </div>
                    </div>
...
<script>
    ...
    function sendemail(message) {
        var email ='anoopkrsh22@gmail.com';
        var subject = document.getElementById("subject").value;
        var userName = document.getElementById("full-name").value;
        var emailbody = 'hi My self ' + userName + ' ' +document.getElementById("message").value;
